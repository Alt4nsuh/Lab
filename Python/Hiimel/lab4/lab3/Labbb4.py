...
def main(puzzle):
    ...
    while True:
        ...
        if np.array_equal(test_node.current_node, END):
...
if __name__ == '__main__':
    ...
    input_image_path = "C:\A_Hicheel\Python\Hiimel\wq.png" 
    bb=shuffle_and_reconstruct(input_image_path)
    print(bb[0])
    br = main(bb[0].tolist())
